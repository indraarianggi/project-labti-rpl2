 ...
 */
package ternaksapi_spring.controller;

import java.util.List;
import javax.swing.JOptionPane;
import ternaksapi_spring.app.App;
import ternaksapi_spring.config.SapiTableModel;
...
public class SapiController {
    ...
    public void tampilData() {
        listSapi = App.getSapiService().getListSapi();
    ...
    public void simpanSapi() {
        ...
        App.getSapiService().saveSapi(sapi);
        clearField();
    ...
    public void updateSapi() {
        ...
        App.getSapiService().updateSapi(sapi);
        clearField();
    ...
    public void deleteSapi() {
        ...
        App.getSapiService().deleteSapi(sapi);
        clearField();
